...
::: {.incremental}
Promptly updating new tweets is critical.

Search keywords need to be dynamically set.

Profile images also help analysts to decide if they will interact with users.
:::
...
👨🏻‍🏫 [https://belisario.website/crossfire_paper/](https://belisario.website/crossfire_paper/)
